...
SPEED_GROUND = 6
IMG_GROUND = pygame.image.load('img3/ground.png')

SPEED_SKY = 1
IMG_SKY = pygame.image.load('img3/sky.png')

IMG_TREX = pygame.image.load('img3/tRex.png')
TIME_CHANGE_TREX = 6
Y_TREX = 105
X_TREX = 50
HIGH_MIN = 90
...
IMG_CATUS = pygame.image.load('img3/cactus.png')
Y_CATUS = 100

BIRD_IMG = pygame.image.load('img3/bird.png')
TIME_CHANGE_BIRD = 10
Y_BIRD_1 = 110
Y_BIRD_2 = 80
Y_BIRD_3 = 50
...
class Bird():
    def __init__(self, x, y, option = 0):
        ...
        self.timeChange = 0
        self.img = pygame.image.load('img3/bird.png')
...
def main():
    ...
    score = Score()
    blinkText = BlinkText("Press UP to play")
    while True:
        isStart = False
