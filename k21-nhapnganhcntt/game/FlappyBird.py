...
IMG_BIRD_1 = pygame.image.load('img1/bird1.png') # Ảnh chim 1
IMG_BIRD_2 = pygame.image.load('img1/bird2.png') # Ảnh chim 2
IMG_COT = pygame.image.load('img1/column.png') # Ảnh cột
...
def main():
    ...
    logo = pygame.image.load('img1/logo.png')
    pygame.display.set_icon(logo)
    IMG_BG = pygame.image.load('img1/bg.bmp').convert()
    scene = Scenes()
    bird = Bird()
    columns = Columns()
    score = Score('0')
